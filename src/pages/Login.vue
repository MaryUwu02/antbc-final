<template>
  <div class="relative min-h-screen bg-white">
    ...
    <section class="min-h-screen grid grid-cols-1 md:grid-cols-2 pt-16 md:pt-0">
      ...
      >
        <div
          class="login-img w-full h-full flex items-center justify-center shadow-lg rounded-b-3xl md:rounded-b-none md:rounded-r-[3rem] overflow-hidden"
        >
        </div>
      </aside>
      ...
      <main class="flex items-center justify-center p-6 md:p-16 bg-white order-2 md:order-none">
        <div class="w-full max-w-md">
          ...
          <p class="mt-6 text-sm text-center text-gray-600 animate-fade-up-3">
            ¿No recordás tus datos?
            <router-link to="/register" class="text-green-700 font-medium underline ml-1 hover:text-green-800 transition">
              Registrarse
            </router-link>
          </p>
